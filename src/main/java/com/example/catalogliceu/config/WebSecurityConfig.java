    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers("administrator_scolar/**").hasAuthority("ROL_ADMINISTRATOR_PLATFORMA")
                        ...
                        .requestMatchers("liceu/{id}").hasAnyAuthority("ROL_ADMINISTRATOR_PLATFORMA", "ROL_ADMINISTRATOR_SCOLAR")
